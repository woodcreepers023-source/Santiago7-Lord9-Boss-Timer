...
# ------------------- Default Boss Data -------------------
default_boss_data = [
    ("Venatus", 600, "2026-03-21 01:07 AM"),
    ("Viorent", 600, "2026-03-21 01:08 AM"),
    ("Ego", 1260, "2026-03-21 04:19 AM"),
    ("Livera", 1440, "2026-03-20 01:11 PM"),
    ("Undomiel", 1440, "2026-03-20 01:15 PM"),
    ("Araneo", 1440, "2026-03-20 01:20 PM"),
    ("Lady Dalia", 1080, "2026-03-20 07:18 PM"),
    ("General Aquleus", 1740, "2026-03-20 11:13 PM"),
    ("Amentis", 1740, "2026-03-20 11:08 PM"),
    ...
    ("Shuliar", 2100, "2026-03-20 12:11 AM"),
    ("Gareth", 1920, "2026-03-21 05:23 AM"),
    ("Titore", 2220, "2026-03-20 02:21 AM"),
    ("Larba", 2100, "2026-03-20 12:07 AM"),
    ("Catena", 2100, "2026-03-20 12:13 AM"),
