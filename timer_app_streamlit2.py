...
# ------------------- Default Boss Data -------------------
default_boss_data = [
    ("Shuliar", 2100, "2026-05-01 00:35 AM"),
    ("Larba", 2100, "2026-05-01 00:35 AM"),
    ("Catena", 2100, "2026-05-01 00:35 AM"),
    ("Venatus", 600, "2026-05-02 01:36 AM"),
    ("Viorent", 600, "2026-05-02 01:38 AM"),
    ("Livera", 1440, "2026-05-01 13:38 PM"),
    ("Araneo", 1440, "2026-05-01 13:41 PM"),
    ("Undomiel", 1440, "2026-05-01 13:44 PM"),
    ("Lady Dalia", 1080, "2026-05-01 19:45 PM"),
    ("Titore", 2220, "2026-05-01 02:41 AM"),
    ("Ego", 1260, "2026-05-02 04:44 AM"),
    ("General Aquleus", 1740, "2026-05-01 23:35 PM"),
    ("Amentis", 1740, "2026-05-01 23:35 PM"),
    ("Metus", 2880, "2026-05-01 13:40 PM"),
    ("Baron Braudmore", 1920, "2026-05-02 05:52 AM"),
    ("Gareth", 1920, "2026-05-02 05:46 AM"),
    ("Wanitas", 2880, "2026-05-01 13:47 PM"),
    ("Duplican", 2880, "2026-05-01 13:52 PM"),
