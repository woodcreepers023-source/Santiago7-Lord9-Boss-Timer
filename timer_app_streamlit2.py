...
# ------------------- Default Boss Data -------------------
default_boss_data = [
    ("Venatus", 600, "2026-05-31 01:20 PM"),
    ("Viorent", 600, "2026-05-31 01:24 PM"),
    ("Ego", 1260, "2026-05-31 07:28 PM"),
    ("Livera", 1440, "2026-05-31 01:12 PM"),
    ("Undomiel", 1440, "2026-05-31 01:19 PM"),
    ("Araneo", 1440, "2026-05-31 01:17 PM"),
    ("Lady Dalia", 1080, "2026-05-31 07:38 PM"),
    ("General Aquleus", 1740, "2026-05-31 09:30 AM"),
    ("Amentis", 1740, "2026-05-31 09:34 AM"),
    ("Baron Braudmore", 1920, "2026-05-30 01:10 PM"),
    ("Wanitas", 2880, "2026-05-30 01:16 PM"),
    ("Metus", 2880, "2026-05-30 01:23 PM"),
    ("Duplican", 2880, "2026-05-30 01:25 PM"),
    ("Shuliar", 2100, "2026-05-30 01:14 PM"),
    ("Gareth", 1920, "2026-05-30 01:15 PM"),
    ("Titore", 2220, "2026-05-31 04:32 AM"),
    ("Larba", 2100, "2026-05-30 10:11 PM"),
    ("Catena", 2100, "2026-05-30 10:22 PM"),
    ("Secreta", 3720, "2026-05-31 05:18 PM"),
    ("Ordo", 3720, "2026-05-31 05:16 PM"),
    ("Asta", 3720, "2026-05-31 05:14 PM"),
    ("Supore", 3720, "2026-05-31 05:19 PM"),
]
